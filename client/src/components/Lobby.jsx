  ...
  return (
    <main className="hero-section lobby-layout fade-in">
      {leaderboard && leaderboard.length > 0 && (
        <div className="lobby-leaderboard-section neon-card glass">
          <header className="leaderboard-header">
            <h2 className="neon-text-gold">🏆 TOP 5 LEGENDY</h2>
          </header>
      ...
      <div className="lobby-bottom-grid">
        <div className="lobby-side-col">
          <div className="online-players-card neon-card glass">
            ...
            <div className="online-list-vertical">
              {onlineStats.players.map((p, i) => (
                <div key={i} className="online-user-item">
                  <span className="status-dot"></span>
                  <span className="online-nickname">{p}</span>
                </div>
              ))}
            </div>
