        ...
        <div className="help-content">
          <section>
            ...
            <ul>
              ...
              <li><strong>Žebříček:</strong> Ukazuje 5 nejlepších hráčů podle <strong>nejvyššího dosaženého skóre v jednom tahu</strong>.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul>
              ...
              <li><strong>Zloděj bodů:</strong> Pokud někdo hodí čistou postupku (1-6), může si vybrat, zda si nechá 2000 bodů, nebo <strong>ukradne 1000 bodů vybranému soupeři</strong>.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ol>
              ...
              <li>Můžeš házet znovu se zbývajícími kostkami, nebo si body zapsat (<strong>BANK</strong>). Pro zápis musíš mít v daném hodu alespoň 350 bodů, a to <strong>nejpozději ve 3. hodu</strong>.</li>
          ...
          <section>
            ...
            <ul>
              ...
              <li><strong>Tři páry:</strong> 700 bodů</li>
            </ul>
          </section>
        </div>
